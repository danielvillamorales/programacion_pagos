...
from programaciones.views import importar,rechazar_acuerdo,aprobar_unico, consulta,aprobar_acuerdo, pendientes_acuerdo,aprobar,totales_ano,totales_mes,detalle_acuerdo, rechazar, aprobar_todo, pendientes, borrar_pendientes, historico, pagos_aprobados,pendientes_next,agregar_cuenta,inactivar_cuenta,cuentas
...
urlpatterns = [
    ...
    path('detalle_acuerdo/<int:anio>/<int:mes>/<int:dia>', detalle_acuerdo, name="detalle_acuerdo"),
